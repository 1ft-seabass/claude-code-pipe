...
または develop ブランチから：
  ...
  git -C ~/workspace/repos/claude-code-pipe tag v0.6.2
  git -C ~/workspace/repos/claude-code-pipe push origin main
  git -C ~/workspace/repos/claude-code-pipe push origin v0.6.2
```
